    ...
    <div class="container">
      <div class="relative -mx-4 flex items-center justify-between">
        <div class="w-60 max-w-full px-4">
          <a href="{{ route('home') }}" class="text-2xl block w-full py-5">
            Logo
          </a>
        </div>
          ...
          <div>
            ...
            <nav id="navbarCollapse"
              ...
              <div class="block lg:flex items-center">
                <ul class="w-1/2 lg:flex 2xl:ml-20">
                  <li class="group relative">
                    <a href="{{ route('home') }}"
                      class="mx-8 flex py-2 font-medium text-base text-dark dark:text-white group-hover:text-primary lg:mr-0 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70">
                      Home
                    </a>
                  </li>
                  <li class="group relative">
                    <a href="{{ route('art.index') }}"
                      class="mx-8 flex py-2 font-medium text-base text-dark dark:text-white group-hover:text-primary lg:mr-0 lg:ml-7 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10">
                      Art
                    </a>
                  </li>
                  <li class="group relative">
                ...
                <ul class="w-1/2 sm:flex sm:justify-center sm:items-center 2xl:ml-20">
                  @guest
                      <div class="md:flex">
                        <a href="{{ route('login') }}" class="loginBtn py-3 px-[22px] text-base font-medium text-white hover:opacity-70">
                          Sign In
                        </a>
                        <a href="{{ route('register') }}"
                          class="signUpBtn rounded-md bg-white bg-opacity-20 py-3 px-6 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark">
                          Sign Up
                        </a>
                      </div>
                  @else
                      <div class="md:flex ">
                        ...
                        class="loginBtn py-3 px-[22px] text-base font-medium text-white hover:opacity-70"
                        >
                          Profile
                        </a>
                        <a href="{{ route('logout') }}"
